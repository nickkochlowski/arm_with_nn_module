...
module top(input  logic       clk, reset,
  ...
  arm arm(clk, reset, PC, Instr, MemWrite, MemtoReg, DataAdr, 
          WriteData, ReadData, InterruptEnable, run_inference, ready);
  imem imem(PC, Instr);
  mixed_width_true_dual_port_ram RAM(nn_address, DataAdr[31:2], nn_wd, WriteData, nn_we, MemWrite, clk, nn_rd, ReadData);   //   1: nn | 2: arm 
